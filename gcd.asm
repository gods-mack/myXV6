  ...
  11:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  if(argc > 1){
  17:	7e 2f                	jle    48 <main+0x48>
  19:	b8 47 00 00 00       	mov    $0x47,%eax
  1e:	b9 25 00 00 00       	mov    $0x25,%ecx
  23:	eb 05                	jmp    2a <main+0x2a>
  ...
  31:	75 f5                	jne    28 <main+0x28>
  	printf(1,"gcd of number %d\n",gcd(37,71));
  33:	83 ec 04             	sub    $0x4,%esp
  36:	51                   	push   %ecx
  37:	68 88 07 00 00       	push   $0x788
  3c:	6a 01                	push   $0x1
  3e:	e8 ed 03 00 00       	call   430 <printf>
  	exit();
  43:	e8 9a 02 00 00       	call   2e2 <exit>
  }
  ...
  48:	52                   	push   %edx
  49:	ff 30                	pushl  (%eax)
  4b:	68 9a 07 00 00       	push   $0x79a
  50:	6a 01                	push   $0x1
  52:	e8 d9 03 00 00       	call   430 <printf>
    exit();
  57:	e8 86 02 00 00       	call   2e2 <exit>
  5c:	66 90                	xchg   %ax,%ax
  5e:	66 90                	xchg   %ax,%ax
...
int gcd(int a, int b){
  ...
  6b:	75 05                	jne    72 <gcd+0x12>
  6d:	eb 11                	jmp    80 <gcd+0x20>
  6f:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	e9 8f fe ff ff       	jmp    478 <printf+0x48>
          s = "(null)";
 5e9:	bb aa 07 00 00       	mov    $0x7aa,%ebx
        while(*s != 0){
