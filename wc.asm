  ...
  a6:	31 ff                	xor    %edi,%edi
{
  ...
  e3:	89 de                	mov    %ebx,%esi
  e5:	89 c3                	mov    %eax,%ebx
  e7:	eb 29                	jmp    112 <wc+0x72>
  e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      c++;
  f0:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
      if(strchr(" \r\t\n\v", buf[i]))
  f4:	83 ec 08             	sub    $0x8,%esp
  f7:	50                   	push   %eax
  f8:	68 78 08 00 00       	push   $0x878
  fd:	e8 4e 01 00 00       	call   250 <strchr>
 102:	83 c4 10             	add    $0x10,%esp
 105:	85 c0                	test   %eax,%eax
 107:	74 1f                	je     128 <wc+0x88>
        inword = 0;
 109:	31 ff                	xor    %edi,%edi
    for(i=0; i<n; i++){
 10b:	83 c3 01             	add    $0x1,%ebx
 10e:	39 de                	cmp    %ebx,%esi
 110:	74 ae                	je     c0 <wc+0x20>
      if(buf[i] == '\n'){
 112:	0f be 83 c0 0b 00 00 	movsbl 0xbc0(%ebx),%eax
 119:	3c 0a                	cmp    $0xa,%al
 11b:	75 d3                	jne    f0 <wc+0x50>
        l++;
 11d:	83 45 e0 01          	addl   $0x1,-0x20(%ebp)
 121:	eb d1                	jmp    f4 <wc+0x54>
 123:	90                   	nop
 124:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      else if(!inword){
 128:	85 ff                	test   %edi,%edi
 12a:	75 df                	jne    10b <wc+0x6b>
        w++;
 12c:	83 45 dc 01          	addl   $0x1,-0x24(%ebp)
        inword = 1;
 130:	bf 01 00 00 00       	mov    $0x1,%edi
 135:	eb d4                	jmp    10b <wc+0x6b>
 137:	89 f6                	mov    %esi,%esi
 139:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  if(n < 0){
 140:	75 26                	jne    168 <wc+0xc8>
  printf(1, "%d %d %d %s\n", l, w, c, name);
 142:	83 ec 08             	sub    $0x8,%esp
 145:	ff 75 0c             	pushl  0xc(%ebp)
 148:	ff 75 e4             	pushl  -0x1c(%ebp)
 14b:	ff 75 dc             	pushl  -0x24(%ebp)
 14e:	ff 75 e0             	pushl  -0x20(%ebp)
 151:	68 8e 08 00 00       	push   $0x88e
 156:	6a 01                	push   $0x1
 158:	e8 c3 03 00 00       	call   520 <printf>
}
 ...
 168:	50                   	push   %eax
 169:	50                   	push   %eax
 16a:	68 7e 08 00 00       	push   $0x87e
 16f:	6a 01                	push   $0x1
 171:	e8 aa 03 00 00       	call   520 <printf>
    exit();
 176:	e8 57 02 00 00       	call   3d2 <exit>
