...
_factorial:     file format elf32-i386
...
main(int argc, char *argv[])
{
  ...
  if(argc > 1){
  14:	83 fb 01             	cmp    $0x1,%ebx
  17:	7e 22                	jle    3b <main+0x3b>
  19:	89 d8                	mov    %ebx,%eax
  1b:	ba 01 00 00 00       	mov    $0x1,%edx
  20:	0f af d0             	imul   %eax,%edx
	if(n==0 ){
  23:	83 e8 01             	sub    $0x1,%eax
  26:	75 f8                	jne    20 <main+0x20>
  	printf(1,"facto %d of %d\n",argc,factorial(argc));
  28:	52                   	push   %edx
  29:	53                   	push   %ebx
  2a:	68 68 07 00 00       	push   $0x768
  2f:	6a 01                	push   $0x1
...
int factorial(int n){
  ...
  5d:	74 09                	je     68 <factorial+0x18>
  5f:	90                   	nop
  60:	0f af c2             	imul   %edx,%eax
  63:	83 ea 01             	sub    $0x1,%edx
  66:	75 f8                	jne    60 <factorial+0x10>
}
  68:	5d                   	pop    %ebp
  69:	c3                   	ret    
  6a:	66 90                	xchg   %ax,%ax
