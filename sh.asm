...
00000150 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     159:	68 5e 12 00 00       	push   $0x125e
     15e:	6a 02                	push   $0x2
...
00000170 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     189:	ff 24 85 78 12 00 00 	jmp    *0x1278(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1a9:	68 cb 11 00 00       	push   $0x11cb
     1ae:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
     ...
     1fd:	68 db 11 00 00       	push   $0x11db
     202:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    panic("runcmd");
     ...
     290:	68 c4 11 00 00       	push   $0x11c4
     295:	e8 b6 fe ff ff       	call   150 <panic>
    panic("fork");
     29a:	83 ec 0c             	sub    $0xc,%esp
     29d:	68 eb 11 00 00       	push   $0x11eb
     ...
     2d8:	68 f0 11 00 00       	push   $0x11f0
...
00000310 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     325:	68 eb 11 00 00       	push   $0x11eb
     ...
     469:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     48d:	50                   	push   %eax
     48e:	68 74 18 00 00       	push   $0x1874
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4dd:	50                   	push   %eax
     4de:	68 74 18 00 00       	push   $0x1874
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     536:	50                   	push   %eax
     537:	68 6c 18 00 00       	push   $0x186c
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     555:	50                   	push   %eax
     556:	68 74 18 00 00       	push   $0x1874
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 74 18 00 00       	push   $0x1874
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     653:	68 12 12 00 00       	push   $0x1212
     658:	53                   	push   %ebx
     659:	56                   	push   %esi
  ...
  return cmd;
     ...
     6de:	68 f5 11 00 00       	push   $0x11f5
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     6ff:	68 15 12 00 00       	push   $0x1215
     704:	57                   	push   %edi
     705:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     74e:	68 2c 12 00 00       	push   $0x122c
     753:	57                   	push   %edi
     754:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     798:	68 1e 12 00 00       	push   $0x121e
  ...
  cmd->eargv[argc] = 0;
     ...
     7ea:	68 17 12 00 00       	push   $0x1217
...
00000800 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     81b:	68 31 12 00 00       	push   $0x1231
     820:	56                   	push   %esi
     821:	53                   	push   %ebx
...
00000870 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     8ab:	68 33 12 00 00       	push   $0x1233
     8b0:	56                   	push   %esi
     8b1:	53                   	push   %ebx
  ...
  if(peek(ps, es, ";")){
     ...
     8c1:	68 2f 12 00 00       	push   $0x122f
     8c6:	56                   	push   %esi
     8c7:	53                   	push   %ebx
...
00000910 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     91f:	68 15 12 00 00       	push   $0x1215
     924:	56                   	push   %esi
     925:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     94b:	68 51 12 00 00       	push   $0x1251
     950:	56                   	push   %esi
     951:	53                   	push   %ebx
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     9b5:	ff 24 85 90 12 00 00 	jmp    *0x1290(,%eax,4)
...
00000a50 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a77:	68 da 11 00 00       	push   $0x11da
     a7c:	53                   	push   %ebx
     a7d:	50                   	push   %eax
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     a9f:	52                   	push   %edx
     aa0:	50                   	push   %eax
     aa1:	68 53 12 00 00       	push   $0x1253
     aa6:	6a 02                	push   $0x2
     aa8:	e8 b3 03 00 00       	call   e60 <printf>
    panic("syntax");
     aad:	c7 04 24 17 12 00 00 	movl   $0x1217,(%esp)
     ...
     dc9:	85 d2                	test   %edx,%edx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     df7:	f7 f1                	div    %ecx
     df9:	0f b6 92 b0 12 00 00 	movzbl 0x12b0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    1014:	e9 8f fe ff ff       	jmp    ea8 <printf+0x48>
          s = "(null)";
    1019:	bb a8 12 00 00       	mov    $0x12a8,%ebx
        while(*s != 0){
